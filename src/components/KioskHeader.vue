...
<template>
  <header class="flex items-center h-fit w-full min-w-0 p-0">
    <RouterLink :to="{ name: 'home' }"
      class="group bg-elevated flex p-6 rounded-3xl w-full justify-start ">
      <UContainer class="header-logo w-fit justify-start flex items-center gap-1.5 sm:p-0 md:p-0 lg:p-0 xl:p-0 mx-0">
        ...
        <span class="text-4xl font-unbounded font-medium text-highlighted">
